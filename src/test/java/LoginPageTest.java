...
public class LoginPageTest extends BaseTest {
    ...
    @Test
    public void logInlogOutCorrectUsernameCorrectPassword1(){
        open("/auth/login/");
        $(byXpath("//input[@name='name']")).sendKeys("hdn_tms"); //вводим в поле ввода "Email" email пользователя
        $(byXpath("//input[@name='name']")).sendKeys(mailSplit); //вводим в поле ввода "Email" email пользователя
        $(byXpath("//input[@name='name']")).sendKeys("mail.ru"); //вводим в поле ввода "Email" email пользователя
